...
const chooseParticipantNum = ref(db, "likelihoods/completedParticipants");
const runBTN = $("run");
var completionArray;
var trials;
...
let selectParticipantNumber = function(){
    ...
    let openSlot = "likelihoods/participants/participant" + parNum.slice(1);
...
let runSurvey = function(){        
    ...
    question.innerHTML = ('<p>Given a person is experiencing the mental state:<br> <b>' + results[curq-1]["stim1"] + '</b> <br><br>how likely will it lead to the action:<br> <b>' + results[curq-1]["stim2"] + '</b>?</p>')
    let submit = $("submit");
    ...
    submit.addEventListener("click", function(e){
        if (moved){
            ...
            if(curq == qn){                     //if its over 
                ...
                question.innerHTML = ('<p>Given a person is experiencing the mental state:<br> <b>' + results[curq]["stim1"] + '</b> <br><br>how likely will it lead to the action:<br> <b>' + results[curq]["stim2"] + '</b>?</p>');
                d = new Date();
                start = d.getTime();
                curq = ++curq;
            }
